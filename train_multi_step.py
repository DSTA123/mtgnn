...
def main(runid):
    ...
    for i in range(1, args.epochs+1):
        ...
        if mvalid_loss<minl:
            torch.save(engine.model.state_dict(), args.save + "exp" + str(args.expid) + "run" + str(runid) +".pth")
            minl = mvalid_loss
    ...
    engine.model.load_state_dict(torch.load(args.save + "exp" + str(args.expid) + "run" + str(runid) +".pth"))
